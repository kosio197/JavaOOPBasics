...
public class Rectangle {
    ...
    private static boolean intersect(Rectangle r1, Rectangle r2) {
        ...
        // if (((r2.yTopLeft < r1.yTopLeft && r2.yTopLeft - r2.height >
        // r1.yTopLeft - r1.height)
        // || (r1.yTopLeft < r2.yTopLeft && r1.yTopLeft - r1.height >
        // r2.yTopLeft - r2.height))
        // && ((r2.xTopLeft > r1.xTopLeft && r2.xTopLeft + r2.width <
        // r1.xTopLeft + r1.width)
        // || (r1.xTopLeft > r2.xTopLeft && r1.xTopLeft + r1.width < r2.xTopLeft
        // + r2.width))) {
        // return false;
        // }
